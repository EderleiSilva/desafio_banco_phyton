...
class Conta:
    ...
    def sacar(self, valor):
        ...
        if excedeu_saldo:
            ...
            print("\nValor de saque informado é inválido.")
    ...
    def depositar(self, valor):
        if valor > 0:
            ...
            print("\nValor de depósito informado é inválido.")
            return False
...
def depositar(clientes):
    ...
    if not cliente:
        print("\nCliente não encontrado, por favor selecione outra opção.")
        return
...
def criar_cliente(clientes):
    ...
    if cliente:
        print("\nCliente já cadastrado, por favor selecione outra opção.")
        return
